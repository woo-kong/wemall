		...
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu">
				...
				<li class="active"><a href="javascript:;"> <i class="fa fa-home"></i>
					...
					<ul class="sub-menu">
						<li class="active"><a href="__APP__/Group/index"> 商城设置</a></li>
			...
			<div class="portlet box light-grey">
				...
				<div class="portlet-body form">
					<form class="form-horizontal" role="form"
						action="__APP__/Group/mallset" method="post">
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label">商城名称</label>
								<div class="col-md-9">
									<input type="text" class="form-control" name="title"
										placeholder="请输入商城的名称" value="<?php echo ($info["title"]); ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">商城公告</label>
								<div class="col-md-9">
									<input type="text" class="form-control" name="gonggao"
										placeholder="请输入商城公告" value="<?php echo ($info["gonggao"]); ?>">
								</div>
							</div>
						</div>

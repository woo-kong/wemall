			...
			<ul class="page-sidebar-menu">
				...
				<li class="active"><a href="javascript:;"> <i class="fa fa-home"></i>
					...
					<ul class="sub-menu">
						...
						<li class="active"><a href="__APP__/Group/theme"> 主题设置</a></li>
			...
			<div class="portlet box light-grey">
				...
				<div class="row">
					<?php if(is_array($theme)): $i = 0; $__LIST__ = $theme;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$themevo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-3">
						<div class="thumbnail">
							<img src="__ROOT__/App/Tpl/<?php echo ($themevo->dir); ?>/thumb.png" style="width: 100%; height: 200px; display: block;" data-src="holder.js/100%x200">
							<div class="caption">
								<h3><?php echo ($themevo->theme); ?></h3>
								<p><?php echo ($themevo->info); ?></p>
								<p><a href="javascript:settheme('<?php echo ($themevo->dir); ?>');" class="btn blue">设置</a></p>
							</div>
						</div>

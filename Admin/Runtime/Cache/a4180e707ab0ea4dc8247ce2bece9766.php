									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<p class="help-block">允许的附件文件类型: jpg,gif,png,jpeg
												并且图片大小小于200k.</p>
											<?php if(!empty($result["picurl"])): ?><input type="hidden" name="image" value="<?php echo ($result["picurl"]); ?>"><img src="__PUBLIC__/Uploads/<?php echo ($result["picurl"]); ?>" id="goodsrc"
												class="img-thumbnail"><?php endif; ?>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">微商城简介</label>
										<div class="col-md-4">
											<textarea type="text" class="form-control" name="description" placeholder=""><?php echo ($result["description"]); ?></textarea>
										</div>
									</div>
								</div>

			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li><a href="#">微商城初始化</a></li>
					</ul>
				</div>
			</div>

			<div class="panel panel-default">
				<div class="panel-heading">微商接口配置URL</div>
				<div class="panel-body"><?php echo ($url); ?>__APP__/Weixin/index</div>
			</div>

			<div class="panel panel-default">
				<div class="panel-heading">微商接口配置Token</div>
				<div class="panel-body">wemall</div>
			</div>
			
			<div class="panel panel-default">
				<div class="panel-heading">手机wemall管理后台</div>
				<div class="panel-body"><?php echo ($url); ?>__ROOT__/mobile.php</div>
			</div>
			
			<div class="panel panel-default">
				<div class="panel-heading">微信打印机通信地址</div>
				<div class="panel-body"><?php echo ($url); ?>__ROOT__/print.php</div>
			</div>
		</div>
	</div>
	<div class="footer">

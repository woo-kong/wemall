	...
	<div class="page-container">
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu">
				...
				<li class="active"><a href="javascript:;"> <i class="fa fa-user"></i>
						<span class="title">用户</span> <span class="arrow "></span>
				</a>
					<ul class="sub-menu">
						<li class="active"><a href="__APP__/Users/index"> 用户管理</a></li>
					</ul></li>
										...
										<thead>
											<tr role="row">
												...
												<th class="sorting" role="columnheader" tabindex="0"
													...
													style="width: 251px;">用户名</th>
												<th class="sorting_disabled" role="columnheader" rowspan="1"
													colspan="1" aria-label="Email" style="width: 464px;">联系方式</th>
												<th class="sorting" role="columnheader" tabindex="0"
													aria-controls="sample_1" rowspan="1" colspan="1"
													aria-label="Points: activate to sort column ascending"
													style="width: 204px;">联系地址</th>
												<th class="sorting_disabled" role="columnheader" rowspan="1"
													colspan="1" aria-label="Joined" style="width: 299px;">创建时间</th>
												<th class="sorting_disabled" role="columnheader" rowspan="1"
